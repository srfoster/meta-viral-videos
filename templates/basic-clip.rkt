...
(provide basic-clip)
(provide basic-clip-in-out
	 (rename-out [basic-clip-in-out clip]))
...
(define/contract (basic-clip-in-out path in out)
  (-> path-string? video-length-string? video-length-string? (or/c mlt? procedure?))

  (lambda ()
    (define in-len (video-length-string->video-length in))
    (define out-len (video-length-string->video-length out))

    (define original-len (video-file-length path))
    (define original-len-s (video-length->string original-len))

    (define len (video-length-subtract out-len in-len))
    ...
    <producer id="producer0" title="Anonymous Submission" in="00:00:00.000" out="@original-len-s">
    <property name="length">@|original-len-s|</property>
    <property name="eof">pause</property>
    <property name="resource">@|abs-path|</property>
    <property name="audio_index">1</property>
    <property name="video_index">0</property>
    ...
    <property name="shotcut:caption">@|abs-path|</property>
    <property name="shotcut:skipConvert">1</property>
    <property name="global_feed">1</property>
    <property name="xml">was here</property>
    </producer>
    ...
    <property name="shotcut:video">1</property>
    <property name="shotcut:name">V1</property>
    <entry producer="producer0" in="@in" out="@out"/>
    </playlist>
    <tractor id="tractor0" title="Shotcut version 19.12.31" global_feed="1" in="00:00:00.00" out="@len-s">
    <property name="shotcut">1</property>
    <property name="shotcut:projectAudioChannels">2</property>
    <property name="shotcut:projectFolder">0</property>
    <track producer="background"/>
